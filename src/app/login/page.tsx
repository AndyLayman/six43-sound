  ...
  return (
    <div className="login-page">
      <div className="login-card">
        ...
        <img src="/logos/Sound-White.svg" alt="Sound" className="login-logo" />
        <h2>Sign in to Soundboard</h2>

        {sent ? (
          <div className="login-sent">
            <p>Check your email for a magic link!</p>
            <p className="login-hint">We sent a sign-in link to <strong>{email}</strong></p>
